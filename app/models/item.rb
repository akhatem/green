...
#  price(Item price)                            :decimal(, )      not null
...
class Item < ApplicationRecord
    ...
    enum item_type: [ :food, :beverage ], _prefix: :item_type
    ...
    validates :item_type, presence: false, if: -> { !item_type.present? }
    ...
    validates :price, presence: false, if: -> { !price.exists? }
